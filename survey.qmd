...
sd_question(
  ...
  label  = "(Multiple Choice) Select all your favorite penguin types:",
  option = c(
    'Adélie' = 'adelie',
    'Chinstrap' = 'chinstrap',
    'Gentoo' = 'gentoo'
...
sd_server(
  ...
  show_if = tibble::tribble(
    ~question_id,  ~question_value, ~target,
    "penguins_1",  "other",         "penguins_1_other",
    "penguins_2",  "other",         "penguins_2_other"
  )
)
```
